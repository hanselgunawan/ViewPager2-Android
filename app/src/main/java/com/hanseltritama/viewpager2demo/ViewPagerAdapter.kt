...
class ViewPagerAdapter(private var title: List<String>, private var description: List<String>, private var images: List<Int>)
    ...
    inner class Pager2ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            itemImage.setOnClickListener {
                ...
                Snackbar.make(it, "You clicked on item #${position + 1}", Snackbar.LENGTH_SHORT).show()
            }
        }
    }
